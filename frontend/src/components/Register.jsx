      ...
      <div className="bg-white w-full max-w-[950px] min-h-[600px] rounded-[2.5rem] shadow-2xl flex overflow-hidden relative">
        ...
        <div className="flex-1 p-10 md:p-14 flex flex-col items-center justify-center">
          ...
          <form onSubmit={handleSubmit} noValidate className="w-full max-w-[320px] space-y-4">
            <input type="email" name="email" placeholder="Email address" value={formData.email} onChange={handleChange} className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#335c67] transition-all placeholder:text-gray-300" />
            <input type="password" name="password" placeholder="Password" value={formData.password} onChange={handleChange} className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#335c67] transition-all placeholder:text-gray-300" />
