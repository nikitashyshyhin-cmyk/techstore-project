...
const Checkout = () => {
  ...
  const handleSubmitOrder = () => {
    // В майбутньому тут буде POST запит для підтвердження замовлення
    console.log("Відправка замовлення:", { deliveryAddress, paymentMethod, comment, total: checkoutData.total });
    // Тимчасове сповіщення для тестування кліку
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 p-6 md:p-8 flex justify-center">
        <div className="text-xl text-[#4B32B1] font-semibold animate-pulse mt-20">
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6 md:p-8">
        <div className="max-w-xl mx-auto bg-white p-10 rounded-md text-center shadow-sm border border-gray-200 mt-10">
          ...
          <button onClick={fetchCheckoutData} className="bg-[#4B32B1] text-white px-8 py-2.5 rounded-md hover:bg-[#3b2888] transition-colors font-semibold">
            Спробувати знову
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-6 md:p-8">
        <div className="max-w-2xl mx-auto bg-white p-20 rounded-md text-center border border-gray-100 mt-10 shadow-sm">
          ...
          <Link to="/products" className="bg-[#4B32B1] text-white px-8 py-3 rounded-md font-semibold hover:bg-[#3b2888] transition-colors inline-block">
            Перейти до каталогу
          </Link>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-md shadow-sm border border-gray-200">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Адреса доставки</label>
                <input
                  type="text"
            ...
            <div className="bg-white p-6 rounded-md shadow-sm border border-gray-200 sticky top-24">
              ...
              <div className="space-y-4 mb-6 text-sm text-gray-600">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-gray-800">
                    {checkoutData.total ? `${checkoutData.total.toLocaleString('uk-UA')} ₴` : '—'}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center border-t border-gray-100 pt-4">
                  <span>Оплата</span>
                  <span className="font-semibold text-[#4B32B1] text-right">
                    {paymentMethod === 'card' ? 'Карткою онлайн' : 'При отриманні'}
                  </span>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 mb-8">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-black text-[#4B32B1]">
                    {checkoutData.total ? `${checkoutData.total.toLocaleString('uk-UA')} ₴` : '—'}
                  </span>
                </div>
              </div>
              ...
              <button 
                ...
                className="w-full bg-[#4B32B1] text-white py-3.5 rounded-md font-semibold hover:bg-[#3b2888] transition-colors shadow-lg shadow-[#4B32B1]/20 text-lg"
              >
