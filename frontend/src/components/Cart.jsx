        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {cartItems.map((item) => {
              ...
              return (
                <div key={item.productId} className="bg-white p-5 rounded-md shadow-sm border border-gray-200 flex flex-col sm:flex-row items-center gap-6 transition-all hover:shadow-md">
